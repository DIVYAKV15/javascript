...
//request send
obj.send()
//request send pannitu response kitan oru time dalay edukum ah time delay calculate cheyyan anu readystate use cheyynnu ..ah readystate 4(max value) avumbo aanu respone kita 
