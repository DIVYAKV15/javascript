...
console.log('w.a.p to print javascript  5 times');
...
console.log('w.a.p to print numbers from 1 to 5 ');
...
console.log('w.a.p to print number from 10 to 1');
...
console.log('w.a.p to print all even number between 1 - 50 ');
...
console.log('w.a.p to find sum of all numbers between 1 - 10');
...
console.log('w.a.p to print the given o/p corresponding a given i/p');
...
i = 1
str = 0
while (i <= input) { //1<=4 2<=4 3<=4 4<=4
    str = str * 10 + i/* 0+10(1)= 1  // 1*10+2=12 //12*10+3 //123*10+4*/
    i++ //2 //3 // 4
}
console.log(str * input)//1234*4 
...
console.log('w.a.p to display reverse of a given number');
...
console.log('w.a.p to check a given number is palindrome or not  ');

pali = 123321
temp = pali/* assigning the value before the we process the pali value so pali changes so we can chec*/
rev = 0
isPalindrome = false;
while (pali > 0) {
    rem = pali % 10/*  1*/
...
console.log('write a progrma to find factorial of a given number');
...
console.log('w.a.p to find the given 3 digit number is armstrong or not');
...
console.log('w.a.p to display a numbers in whose exponential in the range of 8 to 36, where the user can input the power');
